...
const DATA = [
  ...
  },
  {
    ...
    "url": "https://swapi.py4e.com/api/starships/11/"
  },
  {
    "name": "X-wing",
    "model": "T-65 X-wing",
  ...
  },
  {
    ...
    "MGLT": "105",
    "starship_class": "Starfighter",
    "pilots": ["https://swapi.py4e.com/api/people/4/"],
    "films": ["https://swapi.py4e.com/api/films/1/"],
    "created": "2014-12-12T11:21:32.991000Z",
    "edited": "2014-12-20T21:23:49.889000Z",
    "url": "https://swapi.py4e.com/api/starships/13/"
  },
  {
    "name": "Executor",
    ...
    "url": "https://swapi.py4e.com/api/starships/15/"
  },
  {
    ...
    "url": "https://swapi.py4e.com/api/starships/17/"
  }
];

type SpacecraftProps = {title: string, model: string, crew: string, hyperdrive_rating: string, cost_in_credits: string}

const Spacecraft = ({title, model, crew, hyperdrive_rating, cost_in_credits}: SpacecraftProps) => (
...
export const StarshipFeedScreen = () => {
  return (
    <SafeAreaView style={styles.container}>
      <FlatList
        data={DATA}
        renderItem={({item}) => <Spacecraft title={item.name} model={item.model} crew={item.crew} hyperdrive_rating={item.hyperdrive_rating} cost_in_credits={item.cost_in_credits} />}
